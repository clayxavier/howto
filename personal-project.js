...
document.getElementById("btnA").addEventListener("tap", function(){ playSound("snare-1")});
document.getElementById("btnB").addEventListener("tap", function(){ playSound("snare-2")});
document.getElementById("btnC").addEventListener("tap", function(){ playSound("kick-1")});
document.getElementById("btnD").addEventListener("tap", function(){ playSound("kick-2")});
document.getElementById("btnE").addEventListener("tap", function(){ playSound("hihat")});
document.getElementById("btnF").addEventListener("tap", function(){ playSound("open-hihat")});
document.getElementById("btnG").addEventListener("tap", function(){ playSound("ayy")});
document.getElementById("btnH").addEventListener("tap", function(){ playSound("sfx")});
